...
object SimpleApp {
  def main(args: Array[String]) {
	...
	val prGraph = graph.staticPageRank(100).cache //Give number of iterations here
	...
	outputrdd.saveAsTextFile("s3://rahulassg2/outputpageranksgraphx100iters.txt")
    val outputtop100 = outputrdd.top(100)(Ordering.by(_._1))
	val outputtop100rdd = sc.parallelize(outputtop100)
	outputtop100rdd.saveAsTextFile("s3://rahulassg2/outputtop100graphx100iters.txt")
	...
	val univsrdd = univs
	univsrdd.saveAsTextFile("s3://rahulassg2/univspageranksgraphx100iters.txt")
	val univstop100 = univsrdd.top(100)(Ordering.by(_._2))
	val univstop100rdd = sc.parallelize(univstop100)
	univstop100rdd.saveAsTextFile("s3://rahulassg2/univstop100graphx100iters.txt")
