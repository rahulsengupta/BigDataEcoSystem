...
object SimpleApp {
  def main(args: Array[String]) {
	...
	for (i <- 1 to 50) { //Give number of iterations here
	...
	outputrdd.saveAsTextFile("s3://rahulassg2/outputpageranksspark50iters.txt")
    val outputtop100 = outputrdd.top(100)(Ordering.by(_._2))
	val outputtop100rdd = sc.parallelize(outputtop100)
	outputtop100rdd.saveAsTextFile("s3://rahulassg2/outputtop100sparkx50iters.txt")
	...
	univsrdd.saveAsTextFile("s3://rahulassg2/univspageranksspark50iters.txt")
	val univstop100 = univsrdd.top(100)(Ordering.by(_._2))
	val univstop100rdd = sc.parallelize(univstop100)
	univstop100rdd.saveAsTextFile("s3://rahulassg2/univstop100spark50iters.txt")
