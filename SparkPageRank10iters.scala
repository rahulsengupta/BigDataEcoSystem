...
object SimpleApp {
  def main(args: Array[String]) {
	...
	for (i <- 1 to 10) { //Give number of iterations here
	...
	outputrdd.saveAsTextFile("s3://rahulassg2/outputpageranksspark10iters.txt")
    val outputtop100 = outputrdd.top(100)(Ordering.by(_._2))
	val outputtop100rdd = sc.parallelize(outputtop100)
	outputtop100rdd.saveAsTextFile("s3://rahulassg2/outputtop100sparkx10iters.txt")
	...
	univsrdd.saveAsTextFile("s3://rahulassg2/univspageranksspark10iters.txt")
	val univstop100 = univsrdd.top(100)(Ordering.by(_._2))
	val univstop100rdd = sc.parallelize(univstop100)
	univstop100rdd.saveAsTextFile("s3://rahulassg2/univstop100spark10iters.txt")
